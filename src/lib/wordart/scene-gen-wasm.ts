...
export class SceneGenWasm extends SceneGen {
  ...
  constructor(params: GeneratorParams) {
    super(params)
    this.collider = new wasm.LayoutGenWasm(params.viewBox.w, params.viewBox.h)
  }
  ...
  clearTags = () => {
    this.tags = []
    this.collider = new wasm.LayoutGenWasm(
      this.params.viewBox.w,
      this.params.viewBox.h
    )
  }
...
export const renderSceneWasmDebug = (
  sceneGen: SceneGenWasm,
  ctx: CanvasRenderingContext2D
) => {
  // @ts-ignore
  window['ctx'] = ctx
