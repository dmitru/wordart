...
export class CollisionDetectorWasm {
  ...
  constructor(wasm: WasmModule, shapeBoundsInverted: HBoundsWasm) {
    this.wasm = wasm
    ...
    this.layoutGen = new wasm.LayoutGenWasm(
      this.shapeBoundsInvertedJs.bounds.w,
      this.shapeBoundsInvertedJs.bounds.h
    )
  }
