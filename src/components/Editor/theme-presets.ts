...
const themePresetConfigs: ThemePresetConfig[] = Object.values({
  ...
  t5: {
    bgcolor: '#353130',
    maskcolor: 'rgba(0,0,128,0.15)',
    colors: ['#d6d6d6'],
  },
  t6: {
    bgcolor: '#fff',
    maskcolor: 'rgba(3,49,140,0.15)',
  ...
  t13: {
    bgcolor: '#000',
    maskcolor: 'rgba(213,167,83,0.15)',
    colors: '#b95c28 #638db2 #f0f0f0 #dbcc58 #1b3c69 #d5a753'.split(' '),
  },
  t14: {
    bgcolor: '#000',
    maskcolor: 'rgba(126,66,166,0.2)',
