    ...
    <SiteLayout>
      <Box>
        ...
        <p>
          ...
          the{' '}
          <a target="_blank" rel="nofollow" href="https://wordcloudy.com">
            wordcloudy.com
          </a>{' '}
        ...
        <p>
          This website relies on services provided by Google. For more details
          about how Google uses your data, please see this link:
          <br />
        ...
        <p>
          ...
          any online forms on the Website. You can choose not to provide us with
          your Personal Information, but then you may not be able to take
          advantage of some of the Website's features. Users who are uncertain
        ...
        <p>
          ...
          our Website. However, we may also collect Personal Information about
          you from other sources. Any of the information we collect from you may
        ...
        <p>
          We may use Google Analytics to monitor and analyze the use of the
          Chrome Theme Creator. Google Analytics is a web analytics service
          offered by Google that tracks and reports app traffic. This data is
          ...
          network. We do not collect any personal information. Only anonymous
          usage information is collected, including but not limited to the
          prevalence of the use of certain app features. You may opt out of
          Google Analytics tracking when you run Chrome Theme Creator for the
          first time. For more information on the privacy practices of Google,
        ...
        <p>
          For more details about how Google uses your data, please see this
          link:
          <br />
          <a href="http://www.google.com/policies/privacy/partners/">
            How Google uses data when you use our partners’ sites or apps.
        ...
        <p>
          ...
          treat Personal Information. When changes are made, we will revise the
          updated date at the bottom of this page. We may also provide notice to
          you in other ways in our discretion, such as through contact
          information you have provided. Any updated version of this Privacy
          Policy will be effective immediately upon the posting of the revised
          Privacy Policy unless otherwise specified. Your continued use of the
          ...
          use your Personal Data in a manner materially different than what was
        ...
        <p>
          ...
          or sending us an email to support[at]wordcloudy.com
        </p>
        <p>This document was last updated on March 10, 2020</p>
      </Box>
    </SiteLayout>
  )
})
